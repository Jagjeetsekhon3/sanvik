...
export default function ProductForm({ product, tenantId }: {
  ...
  const [instagramVideoUrl, setInstagramVideoUrl] = useState<string>(product?.instagram_video_url ? String(product.instagram_video_url) : '')
  ...
  const [selectedSizeGuideId, setSelectedSizeGuideId] = useState<string>((product?.size_guide_id as string) || '')
